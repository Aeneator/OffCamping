...
offset, getChildRadius = true, getViewStyleRadius = true, paintInside: paintInsideProp, viewStyle, safeRender = false, }) => {
        ...
        const cornerRadiusPartial = (() => {
            if (radiusProp) {
                if (typeof radiusProp === 'number')
                    ...
                    return utils_1.objFromKeys(cornersArray, (k) => radiusProp[k] ?? radiusProp.default);
            }
            ...
            if (getViewStyleRadius) {
                const mergedViewStyle = react_native_1.StyleSheet.flatten(viewStyle ?? {}); // Convert possible array style to a single obj style.
                mergedStyle = utils_1.objFromKeys(cornersArray, (k) => mergedViewStyle[utils_1.cornerToStyle(k, false)] ?? mergedViewStyle[utils_1.cornerToStyle(k, true)] ?? mergedViewStyle?.borderRadius);
            }
            ...
            if (getChildRadius && Object.values(mergedStyle).includes(undefined)) {
                ...
                const childStyleTemp = (react_1.default.Children.only(children)?.props?.style);
                const childStyle = react_native_1.StyleSheet.flatten(childStyleTemp ?? {}); // Convert possible array style to a single obj style.
                mergedStyle = utils_1.objFromKeys(cornersArray, (k) => mergedStyle[k] ?? // Don't overwrite viewStyle already defined radiuses.
                    childStyle[utils_1.cornerToStyle(k, false)] ?? childStyle[utils_1.cornerToStyle(k, true)] ?? childStyle?.borderRadius);
            }
            return mergedStyle;
        })();
        /** Round and zero negative radius values */
        const radiiPreSizeLimit = utils_1.objFromKeys(cornersArray, (k) => R(Math.max(cornerRadiusPartial[k] ?? 0, 0)));
    ...
    const shadow = react_1.useMemo(() => {
        ...
        const startColorWoOpacity = polished_1.rgbToColorString({ ...startColorRgb, alpha: undefined }); // overwrite alpha
        const finalColorWoOpacity = polished_1.rgbToColorString({ ...finalColorRgb, alpha: undefined });
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            activeSides.left && react_1.default.createElement(react_native_svg_1.Svg, { width: distanceWithAdditional, height: heightWithAdditional, style: { position: 'absolute', left: -distance, top: topLeft, ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
            ...
            activeSides.right && react_1.default.createElement(react_native_svg_1.Svg, { width: distanceWithAdditional, height: heightWithAdditional, style: { position: 'absolute', left: width, top: topRight, ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
                react_1.default.createElement(react_native_svg_1.Defs, null,
            ...
            activeSides.bottom && react_1.default.createElement(react_native_svg_1.Svg, { width: widthWithAdditional, height: distanceWithAdditional, style: { position: 'absolute', top: height, left: bottomLeft, ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
                react_1.default.createElement(react_native_svg_1.Defs, null,
            ...
            activeSides.top && react_1.default.createElement(react_native_svg_1.Svg, { width: widthWithAdditional, height: distanceWithAdditional, style: { position: 'absolute', top: -distance, left: topLeft, ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
                react_1.default.createElement(react_native_svg_1.Defs, null,
            ...
            activeCorners.topLeft && react_1.default.createElement(react_native_svg_1.Svg, { width: topLeftShadow + additional, height: topLeftShadow + additional, style: { position: 'absolute', top: -distance, left: -distance, ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
            ...
            paintInside && react_1.default.createElement(react_native_svg_1.Svg, { width: widthWithAdditional, height: heightWithAdditional, style: { position: 'absolute', ...(isRTL && { transform: [{ scaleX: -1 }] }) } },
                react_1.default.createElement(react_native_svg_1.Defs, null,
