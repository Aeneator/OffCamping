...
exports.cornerToStyle = exports.objFromKeys = void 0;
/** Auxilary function to shorten code */
function objFromKeys(keys, fun) {
    return keys.reduce((obj, key) => ({ ...obj, [key]: fun(key) }), {});
}
exports.objFromKeys = objFromKeys;
function cornerToStyle(corner, alternative) {
    switch (corner) {
...
exports.cornerToStyle = cornerToStyle;
